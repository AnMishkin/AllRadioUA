...
package download.mishkindeveloper.AllRadioUA.ui.adMobNative.nativetemplates;
...
public class TemplateView extends FrameLayout {
	...
	private TextView ratingBarView;
	...
	public void onFinishInflate() {
		...
		ratingBarView = findViewById(R.id.rating_bar_view);
